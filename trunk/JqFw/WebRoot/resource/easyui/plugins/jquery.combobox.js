...
(function($) {
	...
	function _1a(_21, _22, _23) {
		...
		// 如果是对象数组，则转换成普通key数组
		if($.isArray(_22) && $.isObject(_22[0])){
			var keyArr = [];
			for (var index = 0; index < _22.length; index++) {
				var bean = _22[index];
				if(bean[_24.valueField]){
					keyArr.push(bean[_24.valueField]);
				}
			}
			_22 = keyArr;
		}
	...
	function _35(_36, url, _37, _38) {
		...
		_39.queryParams = _39.queryParams || {};
		var param = $.isFunction(_39.queryParams)
				? _39.queryParams()
				: _39.queryParams;
		...
		// zzy+ 用通用ajax
		$.query(_39['list'], _37, function(_3a) {
					if (!$.isEmpty(_3a)) {
						_3a = $.decode(_3a);
					}
					if (_3a['rows']) {
...
//		if (_44.url != null) {
//			if (_44.list == null) {
//				_44.list = _44.url + '/list'
//			};
//
//			if (_44.remove == null) {
//				_44.remove = _44.url + '/remove'
//			}
//
//			if (_44.save == null) {
//				_44.save = _44.url + '/save'
//			}
//		}
