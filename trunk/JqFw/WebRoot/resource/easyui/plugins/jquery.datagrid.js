...
(function($) {
	...
	function _19(_1a) {
		...
		if (_1c.length) {
			...
			msg.css({
						left : (_1b.width() - msg.outerWidth()) / 2,
						top : (_1b.height() - msg.outerHeight()) / 2
					});
		}
	};
	...
	function _2e(_2f, _30) {
		...
		var _35 = $("<div class=\"datagrid-wrap\">"
				...
				+ "</div>" + "</div>").insertAfter(_2f);
		_35.panel({
					doSize : false
				});
		_35.panel("panel").addClass("datagrid").bind("_resize",
				function(e, _36) {
	...
	function _40(_41) {
		...
		_43.panel($.extend({}, _42, {
					doSize : false,
					onResize : function(_44, _45) {
						_19(_41);
						setTimeout(function() {
		...
		var _49 = _47.children("div.datagrid-header")
				.children("div.datagrid-header-inner");
		var _4a = _48.children("div.datagrid-header")
				.children("div.datagrid-header-inner");
		...
		_47.find("div.datagrid-footer-inner").css("display",
				_42.showFooter ? "block" : "none");
		_48.find("div.datagrid-footer-inner").css("display",
				_42.showFooter ? "block" : "none");
		if (_42.toolbar) {
			if (typeof _42.toolbar == "string") {
				...
				for (var i = 0; i < _42.toolbar.length; i++) {
					...
					if (btn == "-") {
						...
						_4c.css("float", "left").appendTo(tb).linkbutton($
								.extend({}, btn, {
											plain : true
										}));
					}
		...
		if (_42.pagination) {
			...
			_4d.pagination({
						pageNumber : _42.pageNumber,
						pageSize : _42.pageSize,
						pageList : _42.pageList,
						onSelectPage : function(_4e, _4f) {
							_42.pageNumber = _4e;
							_42.pageSize = _4f;
							_133(_41);
						}
				...
				for (var j = 0; j < _53.length; j++) {
					...
					if (col.checkbox) {
						...
						if (col.field) {
							...
							col.boxWidth = $.boxModel ? (col.width - (_55
									.outerWidth() - _55.width())) : col.width;
	...
	function _56(_57) {
		...
		_5b.find("td[field]").unbind(".datagrid").bind("click.datagrid",
				function() {
		...
		_5b.find("div.datagrid-cell-check input[type=checkbox]")
				.unbind(".datagrid").bind("click.datagrid", function(e) {
					var _67 = $(this).parent().parent().parent()
	...
	function _6b(_6c) {
		...
		_6f.find("td:has(div.datagrid-cell)").unbind(".datagrid").bind(
				"mouseenter.datagrid", function() {
		...
		_6f.find("input[type=checkbox]").unbind(".datagrid").bind(
		...
		_73.children("div.datagrid-body").unbind(".datagrid").bind(
				"scroll.datagrid", function() {
					_72.children("div.datagrid-body").scrollTop($(this)
							.scrollTop());
					_73.children("div.datagrid-header").scrollLeft($(this)
							.scrollLeft());
					_73.children("div.datagrid-footer").scrollLeft($(this)
							.scrollLeft());
				});
		function _74(_75, _76) {
			...
			_75.bind("click.datagrid", function(e) {
						...
						if (_6e.onSortColumn) {
							_6e.onSortColumn.call(_6c, _6e.sortName,
									_6e.sortOrder);
						}
					});
		};
		...
		_6f.find("div.datagrid-cell").each(function() {
			$(this).resizable({
				...
				onStartResize : function(e) {
					...
					_71.children("div.datagrid-resize-proxy").css({
								left : e.pageX - $(_6d).offset().left - 1,
								display : "block"
							});
					_74($(this), false);
				},
				...
				onStopResize : function(e) {
					...
					_7a.find("div.datagrid-header").scrollLeft(_7a
							.find("div.datagrid-body").scrollLeft());
					_71.children("div.datagrid-resize-proxy").css("display",
							"none");
					_6e.onResizeColumn.call(_6c, _79, col.width);
				}
			});
		});
		_72.children("div.datagrid-header").find("div.datagrid-cell")
				.resizable({
					onStopResize : function(e) {
						_6f.css("cursor", "");
						...
						_7c.find("div.datagrid-header").scrollLeft(_7c
								.find("div.datagrid-body").scrollLeft());
						_71.children("div.datagrid-resize-proxy").css(
								"display", "none");
						_a(_6c);
	...
	function _7d(_7e) {
		...
		function _8a(col, _8b) {
			...
			col.width += _8b;
			col.boxWidth += _8b;
			_81.find("td[field=\"" + col.field + "\"] div.datagrid-cell")
					.width(col.boxWidth);
		};
	};
	...
	function _a9(_aa, _ab) {
		...
		if (!_ac.remoteSort) {
			...
			if (opt) {
				...
				_ab.rows.sort(function(r1, r2) {
							return _b0(r1[_ac.sortName], r2[_ac.sortName])
									* (_ac.sortOrder == "asc" ? 1 : -1);
						});
			}
		}
		...
		_ac.view.render.call(_ac.view, _aa, _b3.children("div.datagrid-body"),
				false);
		_ac.view.render.call(_ac.view, _aa, _b2.children("div.datagrid-body")
						.children("div.datagrid-body-inner"), true);
		if (_ac.showFooter) {
			_ac.view.renderFooter.call(_ac.view, _aa, _b3
							.find("div.datagrid-footer-inner"), false);
			_ac.view.renderFooter.call(_ac.view, _aa, _b2
	...
	function _c2(_ce) {
		...
		var _d3 = _d0
				.find("div.datagrid-body div.datagrid-cell-check input[type=checkbox]");
		$.fn.prop ? _d3.prop("checked", false) : _d3.attr("checked", false);
		$("div.datagrid-body tr.datagrid-row-selected", _d0)
	...
	function _69(_d5, _d6) {
		...
		if (top <= 0) {
			...
			if (top + tr.outerHeight() > _dd.height() - 18) {
				_dd.scrollTop(_dd.scrollTop() + top + tr.outerHeight()
						- _dd.height() + 18);
			}
		}
	};
	...
	function _6a(_e4, _e5) {
		...
		var ck = $("tr[datagrid-row-index=" + _e5
						+ "] div.datagrid-cell-check input[type=checkbox]", _ea);
	 ...
	 * 获取当前正在编辑的行的值
	 */
	function getCurrEdittingRow(_f3, _f4){
			...
			if (col && col.editor) {
				...
				if (_10b) {
					...
					$.data(cell[0], "datagrid.editor", {
								actions : _10b,
								target : _10b.init(cell.find("td"), _10a),
								field : _108,
								type : _109,
								oldHtml : _10c
							});
...
//		}
		...
		var param = $.isFunction(opts.queryParams) ? opts.queryParams() : opts.queryParams;
		var _137 = $.extend({}, param);
...
//					});
		...
		// 延时加载
		setTimeout(function() { _138(); }, 0);
		function _138() {
			
			// zzy+ 统一ajax请求
			$.query(opts['list'], _137, function(data){	// 成功处理
				setTimeout(function() { $(_134).datagrid("loaded"); }, 0);
				_a9(_134, data);
				setTimeout(function() { _127(_134); }, 0);
			}, function(){	// 失败处理
				setTimeout(function() { $(_134).datagrid("loaded"); }, 0);
				if (opts.onLoadError) {
...
//					});
	...
	function _139(_13a, _13b) {
		...
		var tr = _13c.find("div.datagrid-body tr[datagrid-row-index="
				+ _13b.index + "]");
	...
	$.fn.datagrid = function(_13e, _13f) {
		...
		return this.each(function() {
					...
					_5(this);
					if ((opts.url && opts.list) && opts['autoLoad']!==false) {
						_133(this);
					}
					_6b(this);
				});
	...
	var _142 = {
		text : {
			init : function(_143, _144) {
				var _145 = $("<input type=\"text\" class=\"datagrid-editable-input\">")
						.appendTo(_143);
				return _145;
			},
		...
		checkbox : {
			...
			setValue : function(_159, _15a) {
				...
				$.fn.prop ? $(_159).prop("checked", _15b) : $(_159).attr(
						"checked", _15b);
			}
		},
		numberbox : {
			init : function(_15c, _15d) {
				var _15e = $("<input type=\"text\" class=\"datagrid-editable-input\">")
						.appendTo(_15c);
				_15e.numberbox(_15d);
				return _15e;
			},
		...
		validatebox : {
			init : function(_166, _167) {
				var _168 = $("<input type=\"text\" class=\"datagrid-editable-input\">")
						.appendTo(_166);
	...
	$.fn.datagrid.methods = {
		options : function(jq) {
			...
			var opts = $.extend(_18b, {
						width : _18c.width,
						height : _18c.height,
						closed : _18c.closed,
						collapsed : _18c.collapsed,
						minimized : _18c.minimized,
						maximized : _18c.maximized
					});
			var _18d = jq.datagrid("getPager");
			if (_18d.length) {
				var _18e = _18d.pagination("options");
				$.extend(opts, {
							pageNumber : _18e.pageNumber,
							pageSize : _18e.pageSize
						});
			}
			return opts;
		},
		...
		reloadFooter : function(jq, _195) {
			return jq.each(function() {
						...
						if (opts.showFooter) {
							opts.view.renderFooter.call(opts.view, this, _197
											.find("div.datagrid-footer-inner"),
									false);
							opts.view.renderFooter.call(opts.view, this, _196
											.find("div.datagrid-footer-inner"),
									true);
			...
			return jq.each(function() {
				...
				if (opts.loadMsg) {
					...
					$("<div class=\"datagrid-mask-msg\" style=\"display:block\"></div>")
							.html(opts.loadMsg).appendTo(_198);
					_19(this);
				}
			});
		},
		 ...
		 * 获取当前正在编辑的行值
		 */
		getCurrRow: function(jq, _19e){
			var target = null;
			
			jq.each(function() { target = this; });
			
			return getCurrEdittingRow(target, _19e);
		},
		...
		updateRow : function(jq, _1a4) {
			return jq.each(function() {
				...
				//zzy+ 处理更新
				if(!_1a4.index || !_1a4.row){
					_1a4 = {
						index: jq.datagrid('getRowIndex', _1a4[opts['idField']]),
						row: _1a4
					};
				}
		...
		deleteRow : function(jq, _1a6) {
			if($.isObject(_1a6)){
				_1a6 = jq.datagrid('getRowIndex', _1a6)
			}
			return jq.each(function() {
						_11a(this, _1a6);
					});
	...
	$.fn.datagrid.parseOptions = function(_1ad) {
		var t = $(_1ad);
		var cfg = $.extend({}, $.fn.panel.parseOptions(_1ad), {
			...
			rowStyler : (t.attr("rowStyler")
					...
					: undefined),
			autoLoad: t.attr("autoLoad")? $.decode(t.attr("autoLoad")) : null, //zzy+
			list: t.attr("list")? $.decode(t.attr("list")) : null, //zzy+
			save: t.attr("save")? $.decode(t.attr("save")) : null, //zzy+
			remove: t.attr("remove")? $.decode(t.attr("remove")) : null //zzy+
		});
		
		// 其他配置项
		if(t.attr("other")){
			cfg = $.extend(cfg, eval(t.attr("other")));
		}
		
		// 查询参数
		if(t.attr('queryParams')){
			cfg['queryParams'] = eval(t.attr("queryParams"));		
		}
	...
	var _1ae = {
		render : function(_1af, _1b0, _1b1) {
			...
			for (var i = 0; i < rows.length; i++) {
				var cls = (i % 2 && opts.striped)
						...
						: "";
				var _1b4 = opts.rowStyler ? opts.rowStyler.call(_1af, i,
						rows[i]) : "";
				var _1b5 = _1b4 ? "style=\"" + _1b4 + "\"" : "";
				_1b3.push("<tr datagrid-row-index=\"" + i + "\" " + cls + " "
						+ _1b5 + ">");
				_1b3.push(this.renderRow.call(this, _1af, _1b2, _1b1, i,
						rows[i]));
				_1b3.push("</tr>");
			}
		...
		renderFooter : function(_1b6, _1b7, _1b8) {
			...
			for (var i = 0; i < rows.length; i++) {
				...
				_1ba.push(this.renderRow.call(this, _1b6, _1b9, _1b8, i,
						rows[i]));
				_1ba.push("</tr>");
			}
		...
		renderRow : function(_1bb, _1bc, _1bd, _1be, _1bf) {
			...
			for (var i = 0; i < _1bc.length; i++) {
				...
				if (col) {
					var _1c2 = col.styler
							? (col.styler(_1bf[_1c1], _1bf, _1be) || "")
							: "";
					var _1c3 = col.hidden ? "style=\"display:none;" + _1c2
							+ "\"" : (_1c2 ? "style=\"" + _1c2 + "\"" : "");
		...
		refreshRow : function(_1c4, _1c5) {
			var row = {};
			var _1c6 = $(_1c4).datagrid("getColumnFields", true).concat($(_1c4)
		...
		updateRow : function(_1c7, _1c8, row) {
			...
			var tr = _1c9.find("div.datagrid-body tr[datagrid-row-index="
					+ _1c8 + "]");
			for (var _1ca in row) {
				...
				if (col) {
					var _1cb = col.styler ? col.styler(rows[_1c8][_1ca],
							rows[_1c8], _1c8) : "";
					td.attr("style", _1cb || "");
					if (col.hidden) {
						td.hide();
					...
					if (col.formatter) {
						cell.html(col.formatter(rows[_1c8][_1ca], rows[_1c8],
								_1c8));
					} else {
			...
			var _1cb = opts.rowStyler ? opts.rowStyler.call(_1c7, _1c8,
					rows[_1c8]) : "";
			tr.attr("style", _1cb || "");
		...
		insertRow : function(_1cc, _1cd, row) {
			...
			var view = $(_1cc).datagrid("getPanel")
					.children("div.datagrid-view");
			...
			for (var i = data.rows.length - 1; i >= _1cd; i--) {
				_1cf.children("div.datagrid-body")
						.find("tr[datagrid-row-index=" + i + "]").attr(
								"datagrid-row-index", i + 1);
				var tr = _1ce.children("div.datagrid-body")
						.find("tr[datagrid-row-index=" + i + "]").attr(
								"datagrid-row-index", i + 1);
				if (opts.rownumbers) {
			...
			var tr1 = "<tr datagrid-row-index=\"" + _1cd + "\">"
					+ this.renderRow.call(this, _1cc, _1d0, true, _1cd, row)
					+ "</tr>";
			var tr2 = "<tr datagrid-row-index=\"" + _1cd + "\">"
					+ this.renderRow.call(this, _1cc, _1d1, false, _1cd, row)
					+ "</tr>";
			if (_1cd >= data.rows.length) {
				var _1d2 = _1ce.children("div.datagrid-body")
				...
				_1ce.children("div.datagrid-body")
						.find("tr[datagrid-row-index=" + (_1cd + 1) + "]")
						.before(tr1);
				_1cf.children("div.datagrid-body")
						.find("tr[datagrid-row-index=" + (_1cd + 1) + "]")
						.before(tr2);
		...
		deleteRow : function(_1d4, _1d5) {
			...
			var view = $(_1d4).datagrid("getPanel")
					.children("div.datagrid-view");
			var _1d6 = view.children("div.datagrid-view1");
			var _1d7 = view.children("div.datagrid-view2");
			_1d6.children("div.datagrid-body").find("tr[datagrid-row-index="
					+ _1d5 + "]").remove();
			_1d7.children("div.datagrid-body").find("tr[datagrid-row-index="
					+ _1d5 + "]").remove();
			for (var i = _1d5 + 1; i < data.rows.length; i++) {
				_1d7.children("div.datagrid-body")
						.find("tr[datagrid-row-index=" + i + "]").attr(
								"datagrid-row-index", i - 1);
				var tr = _1d6.children("div.datagrid-body")
						.find("tr[datagrid-row-index=" + i + "]").attr(
								"datagrid-row-index", i - 1);
				if (opts.rownumbers) {
		...
		onAfterRender : function(_1d9) {
			...
			if (opts.showFooter) {
				var _1da = $(_1d9).datagrid("getPanel")
...
$.extend($.fn.datagrid.methods, {
	/**
	 * 添加记录
	 * @param {} jq jq对象，在调用时看不见
	 * @param {} ops 操作参数，共分3种情况：
	 * 						第一种：为空，则添加一行默认空行
	 * 						第二种: json对象，则添加一行指定记录
	 * 						第三种：json数组，则添加多行指定记录
	 * 						第四种：如：{
	 * 								  rows: [{},{}], //json数组
	 * 								  isEdit: false //不需要编辑
	 * 								  callFun: function(target, rows){}
	 * 								}
	 */
	'add': function(jq, ops){
		// 如果当前已经有文件正在编辑，则不可用
		if(jq.datagrid('getEdittingId') != null){
			$.msg.show({
				title: '提示',
				msg:'当前有行正在编辑，请保存正在编辑的行后进行其他操作!'
			});
			return;
		}
		...
		// 获取idField
		var idField = $.data(target, 'datagrid')['options']['idField'];
		...
		}else if($.isArray(ops)){ // 如果是json数组
			ops = {
				rows: ops
			};			
		}else if(!(ops['rows'] && String(ops['isEdit']))){// 如果是json
			ops = {
				rows: [ops]
			};
		}
		...
		for (var index = 0; index < ops.rows.length; index++) {
			var row = ops.rows[index];
			// 设置逻辑主键
			if( !ops.rows[index][idField] ){
				ops.rows[index][idField] = $.uuidVal();
			}
		}
		
		// 添加节点
		jq.datagrid('appendRow', ops['rows']);
		
		var rowIndex = jq.datagrid('getRowIndex', ops['rows'][idField]);
		...
		if(ops['isEdit']){
			...
			// 选中当前添加的记录
			jq.datagrid('selectRow', rowIndex);
			
			$.data(target, 'datagrid')['currentEdittingOldRow'] = ops['rows'][0];
			$.data(target, 'datagrid')['currentEdittingRowIndex'] = rowIndex;
	...
	'edit': function(jq){
		...
		if (row){
			$.data(target, 'datagrid')['currentEdittingOldRow'] = row;
			$.data(target, 'datagrid')['currentEdittingRowIndex'] = jq.datagrid('getRowIndex', row);
			jq.datagrid('beginEdit', $.data(target, 'datagrid')['currentEdittingRowIndex']);
		}
	},
	'save': function(jq){
		var target = null;
		...
		var id = jq.datagrid('getEdittingId');
		if(id == null){
			$.msg.show({
				title: '提示',
				msg:'没有需要保存的记录!'
		...
		var row = jq.datagrid('getCurrRow', $.data(target, 'datagrid')['currentEdittingRowIndex']);
		
		$.exec($.data(target, 'datagrid')['options']['save'], row[0], function(data){
			$.msg.say("保存成功!");
			// 停止编辑
			jq.datagrid('endEdit', id);
			// 更新界面行记录
			jq.datagrid('updateRow', data);
			
			$.data(target, 'datagrid')['currentEdittingOldRow'] = null;
			$.data(target, 'datagrid')['currentEdittingRowIndex'] = null;
		});
	...
	'delete': function(jq){
		...
		// 获取选中的节点
		var node = jq.datagrid('getSelected');
		
		if(node == null){
			$.msg.say("没有选中要删除的记录，请确认！");
			return;
		}
		...
		$.msg.confirm('询问', '是否删除当前选中记录？', function(r){
			if (r){
				$.exec($.data(target, 'datagrid')['options']['remove'], node, function(data){
					$.msg.say("删除成功!");
					$.data(target, 'datagrid')['currentEdittingOldRow'] = null;
					$.data(target, 'datagrid')['currentEdittingRowIndex'] = null;
					jq.datagrid("remove", data[idField]);
				});				
			}
		});
	...
	'getEdittingId': function(jq){
		...
		return $.data(target, 'datagrid')['currentEdittingOldRow'] 
					? $.data(target, 'datagrid')['currentEdittingOldRow'][idField] : null;	
	}
});