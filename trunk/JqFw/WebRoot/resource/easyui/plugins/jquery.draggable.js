...
(function($) {
	...
	function _2(e) {
		//zzy+
		if(!$.data(e.data.target, "draggable"))return;
	...
	function _a(e) {
		...
		var _c = $(".droppable").filter(function() {
					...
					if (_d) {
						$.msg.say($.isFunction(_d));
						//zzy+ 自定义accept
						if($.isFunction(_d)){
							return _d.call(this, e);
						}
	...
	function _f(e) {
		_2(e);
		if ($.data(e.data.target, "draggable") && $.data(e.data.target, "draggable").options.onDrag.call(
		...
		// zzy+
		if($.data(e.data.target, "draggable")){
	...
	function _12(e) {
		...
		function _15() {
			...
			$.data(e.data.target, "draggable").droppables.each(function() {
						...
						var p2 = $(this).offset();
						if (e.pageX > p2.left
								&& e.pageX < p2.left + _18.outerWidth()
								&& e.pageY > p2.top
	...
	$.fn.draggable = function(_19, _1a) {
		...
		return this.each(function() {
					...
					if (typeof _1b.handle == "undefined" || _1b.handle == null) {
						...
						_1d = (typeof _1b.handle == "string" ? $(_1b.handle,
								this) : _1b.handle);
					}
					$.data(this, "draggable", {
								options : _1b,
					...
					_1d.unbind(".draggable").bind("mousemove.draggable", {
								...
								$(document).bind("mousedown.draggable", e.data,
										_a);
								$(document).bind("mousemove.draggable", e.data,
										_f);
								$(document).bind("mouseup.draggable", e.data,
										_12);
